 ...
 */
final class Version20220312013645 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP quantity, CHANGE status status VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
